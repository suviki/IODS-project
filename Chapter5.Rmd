...
keep_colums <- c("breakfast", "tea.time", "evening", "lunch", "dinner", "always")
tea2 <- select(tea, one_of(keep_colums))
str(tea2)
dim(tea2)
...
As can be seen from the picture, the variables are drawn on the first two dimensions. The distance between variable categories gives a measure of their similarity. Looks like tea time, not always and breakfast are quite similar. Dinner differs the most from the other variables.